...
const data = {
    ...
    Home: {
        introduction: "I am a PhD student at the University of Michigan in Biostatistics focusing on statistical genetics. I have a MS in Biostatistics from the University of Michigan (2024) and a BS in Mathematics and Computer Science from Wake Forest University (2022).",
    ...
    About: {
        ...
        about: {
            "tech-stats" : "Statistical Geneticist, Machine Learning Engineer, and High Performance Computing Programmer",
        ...
        education: [
            {
                ...
                textAlignment: "right",
                degree: "Bachelor of Science (B.S.), Mathematics and Computer Science",
    ...
    Portfolio: [
        {
            ...
            delay: "0.5s",
            project: "pyGEMMA",
            description: "This is a Python/R implementation of linear mixed models originally developed for GWAS. We also incorperate efficient algorithms that scale to HPC systems, enabling the efficient analysis of biobank-scale data.",
            placement: "top"
        },
        {
